%% Sets the upper and lower bounds for each reaction based on the gene expression and performs FVA 
function [minFlux, maxFlux, Vmin, Vmax] = evaluate_objective_FVA(x, M, V, fbamodel, geni, reaction_expression, pos_genes_in_react_expr, ixs_geni_sorted_by_length)
